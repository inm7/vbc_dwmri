...
cp -r /opt/freesurfer/subjects/${avg} ${fp}/
cp -r /opt/freesurfer/subjects/${avg} ${ap}/
...
do
    mri_surf2surf --srcsubject ${sbj_id} --trgsubject ${avg} --hemi lh --sval-annot ${fp}/${sbj_id}/label/lh.${atl}.annot --tval ${ap}/${avg}/lh.${atl}_${sbj_id}.annot
    mri_surf2surf --srcsubject ${sbj_id} --trgsubject ${avg} --hemi rh --sval-annot ${fp}/${sbj_id}/label/rh.${atl}.annot --tval ${ap}/${avg}/rh.${atl}_${sbj_id}.annot
done
export SUBJECTS_DIR=/opt/freesurfer/subjects
