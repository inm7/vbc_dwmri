function matlab_FC_postprocess(input_options)
    ...
    % preproc_dir = '/Volumes/PROJECTS/Data/Functional_Connectivity/PD_HHU_by_KJung';
    % target_dir  = '/Volumes/PROJECTS/Data/Functional_Connectivity/PD_HHU_by_KJung';
    % atlCond     = {'sch','ho','kst','dk','sth'};
    % filtCond    = {'notf','bptf_mat','l_bptf_mat','h_bptf_mat'};
