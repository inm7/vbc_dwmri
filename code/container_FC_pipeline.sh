...
# tp=/data/project/personalized_pipeline/03_Functional_Connectivity/PD_HHU_by_KJung

# case ${fn} in
# 	list_PD_HHU_QC_N73_Intact.txt )
# 	grp=PD_HHU
# 	pp=/data/project/personalized_pipeline
# 	;;
# 	list_PD_HHU_QC_N43_Culled.txt )
# 	grp=PD_HHU_culled
# 	pp=/data/project/SC_pipeline
# 	;;
# 	* )
# 	printf "  + Specify a correct subject list text file!"
# 	exit
# 	;;
# esac
# fp=${pp}/Neuroimage/Tools/freesurfer/subjects
